...
export const prizes: Prize[] = [
  {
    ...
    images: ['/prizes/ipad.jpg', '/prizes/ipad.jpg'],
  ...
  },
  {
    ...
    images: ['/prizes/hugging_face_icon.svg'],
    eligability_criteria:
  ...
  },
  {
    ...
    images: ['/icons/icon.ico', '/icons/icon.ico'],
    eligability_criteria:
  ...
  },
  {
    ...
    images: ['/prizes/beats_headphone.jpg'],
    eligability_criteria:
  ...
  },
  {
    ...
    prizes: ['1 Plushie'],
    images: ['/prizes/cute_cat_plushies.jpg'],
    eligability_criteria:
