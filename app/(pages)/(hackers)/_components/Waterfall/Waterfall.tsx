...
export default function Waterfall() {
  return (
    <div className="relative flex w-0 md:w-full overflow-x-clip flex-col items-center justify-evenly md:bg-grass-background-darker md:w-full md:h-[calc(100vw*600/1440)] z-10">
      {/* Top div with WaterfallGrass */}
      <div className="absolute top-[-26.5%] w-0 md:w-[100%] aspect-[1440/463]">
      ...
      <div className="w-0 h-0 md:h-auto md:w-full flex justify-between items-start z-10">
        ...
        <div className="flex flex-col space-y-2 flex-1">
          ...
          <div className="relative z-30 aspect-[464/286] w-0 md:w-[calc(100vw*464/1440)] translate-y-[calc(-1*100vw*80/1440)]">
            <Image
              src={BunnyPlatform}
              alt="Bunny Platform"
              className="w-full"
        ...
        <div className="flex flex-col items-end space-y-2 flex-1 z-10 top-[calc(100vw*240/1440)]">
          <div className="relative z-10 aspect-[227/230] w-0 md:w-[calc(100vw*227/1440)] right-[calc(100vw*154/1440)] translate-y-[calc(100vw*157/1440)]">
            <Image
              src={KeyboardDucky}
              alt="Keyboard Ducky"
              className="w-full"
          ...
          <div className="relative z-20 aspect-[480/153] w-0 md:w-[calc(100vw*480/1440)] translate-y-[calc(100vw*130/1440)]">
            <Image src={DuckPlatform} alt="Duck Platform" className="w-full" />
          </div>
          <div className="relative z-40 aspect-[260/152] w-0 md:w-[calc(100vw*260/1440)] right-[calc(100vw*190/1440)] translate-y-[calc(-1*100vw*15/1440)]">
            <Image
              src={SleepingFroggy}
              alt="Sleeping Froggy"
              className="w-full"
          ...
          <div className="relative z-30 asect-[506/293] w-0 md:w-[calc(100vw*506/1440)] translate-y-[calc(-1*100vw*100/1440)]">
      ...
      <div className="relative z-10 aspect-[134/164] w-0 md:w-[calc(100vw*134/1440)] left-[calc(100vw*300/1440)] translate-y-[calc(-1*100vw*1150/1440)]">
        <Image src={MusicNotes} alt="Music Notes" className="w-full" />
      </div>

      {/* Temporarily removed */}
      {/* <div className="relative z-10 aspect-[227/230] w-[calc(100vw*227/375)] right-[calc(100vw*40/375)] md:w-0">
