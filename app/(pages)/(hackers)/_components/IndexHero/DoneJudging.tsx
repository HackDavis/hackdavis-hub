        ...
        <div>
             <div className={styles.container}>
                <div className={styles.text_container}>
                    <p>CONGRATS!</p>
                    <br />
                    <p>You’re all done, thank you so much for your participation at HackDavis 2025. Please wait until <b>Closing Ceremony</b> for judging results! In the meantime, put in your vote for <a href='/' target='_blank'>Hacker’s Choice Award</a> and check out our insta <b>@hackdavis!</b></p>
                </div>
                <Image src={stars} alt='stars' className={styles.stars_img}/>
                <Image src={bunny_phone} alt='bunny phone' className={styles.bunny_phone_img}/>
            </div>
            <div className={styles.grid_container}>
                <div className={styles.left_container}>
                    <Image src={bunny_phone} alt='bunny phone' className={styles.bunny_phone_img_mobile}/>
