    ...
    const [notifications, setNotifications] = useState([
        {
          id: 1,
          name: 'MLH Track',
          description: 'Since you submitted for an MLH track, you will also be visited by a representative.',
        },
        {
          id: 2,
          name: 'NPO Track',
          description: 'Since you submitted for an NPO track, you will also be visited by a representative.',
        },
        {
          id: 3,
          name: 'Reminder',
          description: 'You and your team need to be present at your assigned table during judging!',
        },
      ]);
