...
export default function PreviousHacks() {
  return (
    <div className="bg-sea-background rounded-[12px] flex flex-col items-center 2xs:p-8 2xs:pb-0 p-4 pb-0 lg:p-8 lg:pb-0 gap-4 md:gap-6 lg:gap-8 2xl:gap-10 overflow-hidden">
