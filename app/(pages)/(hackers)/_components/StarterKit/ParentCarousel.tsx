  ...
  return (
    <div className="relative flex items-center justify-between px-0 xl:pr-4 -mb-12 lg:-mb-14 z-50 ">
      <Image
        src={judge_bunny}
        alt="judge_bunny"
        className="absolute z-10 -right-2 xs:-right-3 bottom-9 w-[80px] xs:w-auto h-[100px] xs:h-[125px] md:h-[150px] xl:h-[200px] xs:aspect-[calc(184/204)] [transform:rotateY(180deg)] md:transform-none md:relative md:-right-0 md:bottom-0"
      />
      <div className="flex flex-col md:flex-row gap-2 xs:gap-3 xl:gap-4 w-full pb-16 md:pb-12 lg:pb-16">
        <div className="flex flex-row items-end gap-4 md:gap-2">
          <div className="flex flex-col items-start justify-around md:h-[50px] xl:h-[65px]">
            <p className="font-jakarta text-[0.5rem] xs:text-xs lg:text-sm xl:text-base font-normal leading-normal md:leading-[15px] lg:leading-[20px] text-[#005271] flex-none order-0 self-stretch">
              SAY HI TO YOUR
            </p>
            <h3 className=" font-metropolis text-lg xs:text-2xl lg:text-2xl xl:text-4xl font-bold leading-5 md:leading-[30px] lg:leading-[40px] tracking-[0.02em] text-[#123041] flex-none order-1">
              Starter Kit
            </h3>
          </div>
          <Image
            src={star}
            alt="star"
            className="aspect-square mb-[3px] xs:mb-[6px] w-[15px] xs:w-[20px] md:w-[10px] lg:w-[25px]"
          />
        </div>
      ...
      <div className="flex flex-col md:items-center -mb-20 mr-5 xs:-mb-32 md:justify-center md:aspect-[calc(256/212)] md:h-[100px] lg:h-[150px] xl:h-[200px]">
        <Image
          src={good_froggie}
          alt="good_froggie"
    ...
    <div className="flex flex-col gap-2 md:flex-row-reverse">
      {activeIndex === 3 ? (
        <a href="/">
          <Button
            variant="default"
            className="flex flex-row justify-center items-center w-full h-fit p-2 bg-background-secondary border-2 border-solid border-background-secondary rounded-[100px] font-jakarta text-xs xs:text-base md:text-lg leading-3 tracking-[0.18px] text-white hover:bg-background-primary"
          >
            Home
          </Button>
        </a>
      ...
      {activeIndex === 0 ? (
        <a href="/">
          <Button
            variant="outline"
            className="flex justify-center items-center w-full h-fit p-2 border-2 border-solid border-background-secondary rounded-[100px] bg-transparent shadow-none font-jakarta text-xs xs:text-base md:text-lg leading-3 tracking-[0.18px] text-background-secondary hover:bg-background-secondary hover:text-white"
          >
            Home
          </Button>
        </a>
                ...
                <div className="md:pt-16">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      />
                      <p className="text-white text-lg xs:text-xl md:text-3xl font-bold text-nowrap">
                        {item.title}
                      </p>
                    </div>
                  </div>
