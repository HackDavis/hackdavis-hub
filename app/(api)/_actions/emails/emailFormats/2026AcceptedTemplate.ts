export default function acceptedTemplate(
  fname: string,
  titoTicket: string,
  hubInvite: string
) {
...
<head>
    ...
    <title>Congratulations from HackDavis!</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="content-box">
            ...
            <p>We are thrilled to welcome you as a hacker at HackDavis 2025! We can't wait to see all the amazing projects and ideas that you'll bring to the table. HackDavis 2025 will take place on April 19th - 20th, 2025 completely in-person at the University Credit Union Center @ UC Davis. ❤️💻🌱</p>
            ...
            <ul>
                <li><span class="highlight">Claim your ticket by April 10th, 11:59 PM PDT here:</span> <a href="${titoTicket}">${titoTicket}</a>
                    <ul>
            ...
            <p>After claiming your ticket using the link above, <span class="highlight">you will receive a unique QR Code</span> which you will use to check-in at the venue on Saturday April 19th. If you are looking for teammates, keep a look out for our <span class="highlight">team mixers in April</span>. You can also utilize the <em>#find-a-team</em> channel on Discord or attend our day-of-the-event team mixer!</p>

            <p>Be sure to follow our Instagram at <span class="highlight">@hackdavis</span> to stay updated! We will publish more information on the Hub and send out logistical details closer to the event.</p>
